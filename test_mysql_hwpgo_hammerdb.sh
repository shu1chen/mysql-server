...
# --- Configuration ---
INSTALLDIR=/home/shuchen1/mysql/installation/mysql_icx_gnr_lto_hwpgo
BASEDIR=$INSTALLDIR/usr/local/mysql
DATADIR=/home/shuchen1/mysql/data_icx_gnr_lto_hwpgo
...
echo "=== MySQL ICX/GNR/LTO/HWPGO HammerDB Test ==="
...
cat > /tmp/hammerdb_hwpgo_test_build.tcl << EOF
dbset db mysql
...
cd $HAMMERDB
./hammerdbcli auto /tmp/hammerdb_hwpgo_test_build.tcl
...
cat > /tmp/hammerdb_hwpgo_test_run.tcl << EOF
dbset db mysql
diset connection mysql_host 127.0.0.1
diset connection mysql_port $PORT
diset connection mysql_socket $SOCKET
...
./hammerdbcli auto /tmp/hammerdb_hwpgo_test_run.tcl
